...
$__FM_CONFIG['database'] = $this->ci->config->item('database');
$__FM_CONFIG['hostspec'] = $this->ci->config->item('hostname');
$__FM_CONFIG['username'] = $this->ci->config->item('username');
$__FM_CONFIG['password'] = $this->ci->config->item('password');
